  ...
  return (
    <Box pt={'10vh'} px={3}>
        ...
        <Box mt={10} p={{md: 7, base: 3}} rounded={5} bg={'gray.200'} color={'black'} maxW={{'2xl': '60%', md: '70%', base: '100%'}} mx={'auto'}>
            <Text textAlign={'center'}>I have had the absolute pleasure of working with lightcietech limited as a lightning and earthing protection systems consultant for over 25 years, and I can confidently say that their expertise is unparalleled in the industry.</Text>
