...
export default function Section6() {
  return (
    <Box py={10} mb={'10vh'} maxW={{'2xl': '90%', md: '100%', base: '100%'}} mx={'auto'} bg={''} color={''}>
        <Box>
        ...
        <Box mt={8} className='grid grid-cols-1 md:grid-cols-4 gap-3 mx-3'>
          <Box bg={'gray.200'} rounded={5}>
            ...
            <Box px={2} py={3} bg={'gray.800'} m={3} color={'white'} rounded={5}>
        ...
        <Flex justifyContent={'center'} mt={6}>
          <Button color={'red.500'} bg={'gray.800'} height={'45px'} fontWeight={400} rounded={3}><Link to={'products'}>See More Of Our Products</Link></Button>
        </Flex>
    </Box>
  )
}