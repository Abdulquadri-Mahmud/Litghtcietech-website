...
export default function Section6() {
  return (
    <Box py={10} mb={'10vh'} maxW={{'2xl': '90%', md: '100%', base: '100%'}} mx={'auto'} bg={'gray.200'} color={''}>
        <Box>
          <Heading textAlign={'center'} fontWeight={500} fontSize={35} color={'black'}>Our <span className="text-red-500">Products</span></Heading>
          <Box width={'120px'} mx={'auto'} mt={3} height={'3px'} bg={'red.500'}></Box>
        </Box>
        <Box mt={8} className='grid grid-cols-1 md:grid-cols-4 gap-3 mx-3'>
          <Box bg={'white'} shadow={'md'} rounded={5}>
            <Flex height={'200px'} justifyContent={'center'} p={3}>
              <Image src='pro9.png'/>
            </Flex>
            <Box py={3} bg={'gray.800'} m={0} color={'white'} rounded={5}>
        ...
        <Flex justifyContent={'center'} mt={6}>
          <Button color={'red.500'} bg={'gray.800'} _hover={{bg: 'gray.700'}} height={'45px'} fontWeight={400} rounded={3}><Link to={'products'}>See More Of Our Products</Link></Button>
        </Flex>
    </Box>
  )
}